...
<div class="navbar">
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-content"> 
        ...
        <a href="http://localhost/findaparent.php"><i class="fa fa-list" style="font-size: 1.2em;padding-right:5px"></i>Adoption Requests</a>
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-content">
            <a href="http://localhost/donationpage.php"><i class="fa fa-credit-card" style="font-size: 1.2em;padding-right:5px"></i>Donate</a>
        </div>
    </div>
...
<div class="form_ans"> 
       ...
       <br><br> 
       <div class="view_ans">
        <a href="http://localhost/faq.php">View all answers</a>
...
<footer id="pageFooter">
            <div style="margin-top: 1.2em" class="down one">
                <h1>Support Us</h1>
                <ul>
                    <li><a href="http://localhost/whydonate.html">Donate Now</a></li>
            ...
            <div  class="down two">
                <h1>Adoption</h1>
               <ul>
                <li><a href="http://localhost/findaparent.php">Available dogs</a></li>
